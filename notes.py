...
#     ax, xkeys, ykeys, border=[True, False, True, False], loglog=True, show_legend=True
# ):
#     """"""
#
#     if loglog:
...
#
#     if show_legend:
#         leg = ax.legend(loc="best", borderaxespad=0.0, framealpha=1.0, fancybox=False, borderpad=1)
...
#
#     mpl_lc.learning_curve_error(
#         ax, xkeys, ykeys, x_range=(-20, 500), y_range=(-5, 60), loglog=False
#     )
#
#     plt.xticks([])
#     plt.yticks([])
...
#     line_data_x = np.array([10 ** 4] * line_data_y.shape[0]) * (
#         1 - np.random.normal(0, 0.05, line_data_y.shape[0])
#     )
#     lineobj = ax.plot(line_data_x, line_data_y, "k", linestyle="dotted")
#
#     yticks = [0.1, 1.0, 10, 100, 10 ** 3, 10 ** 4]
#     line_data_y = np.array(yticks)
#     line_data_x = np.array([10 ** 5] * line_data_y.shape[0]) * (
#         1 - np.random.normal(0, 0.05, line_data_y.shape[0])
#     )
#     lineobj = ax.plot(line_data_x, line_data_y, "k", linestyle="dotted")
#
...
#     ax.text(
#         0.6, 0.5, r"$\left ( \vec R, \vec Z \right ) \frac{{ML}}{{\rightarrow}} P$", **method_opt
#     )
#     ax.plot([0.5], [0.5], "k.")
#
#     ax.text(
#         3.0,
#         3.5,
#         r"$\hat H \left ( \vec R, \vec Z \right ) \frac{{\Psi}}{{\rightarrow}} P$",
#         **method_opt_prime,
#     )
#
#     # labels
...
#     "k-",
#     path_effects=[
#         matplotlib.patheffects.withStroke(linewidth=8, foreground="w"),
